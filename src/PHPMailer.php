...
class PHPMailer
{
   ...
   // Check if Debugoutput is a PSR-3 logger, but first ensure the interface exists
   // if (interface_exists('\Psr\Log\LoggerInterface') && isset($this->Debugoutput) && $this->Debugoutput instanceof \Psr\Log\LoggerInterface
//) {
